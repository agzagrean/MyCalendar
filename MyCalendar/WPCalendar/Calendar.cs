...
namespace WPCalendar
{
    ...
    public partial class Calendar : Control
    {
        ...
        protected virtual void RaiseEventCalendarChanged(EventCalendar calendar)
        {
        ...
        {
            get { return (string)GetValue(DayOfTheWeekProperty); }
            internal set { SetValue(DayOfTheWeekProperty, value); }
        }

        /// <summary>
        /// This value is shown in detail view header and represents the day of the week
        /// </summary>
        public static readonly DependencyProperty DayOfTheWeekProperty =
            DependencyProperty.Register("DayOfTheWeek", typeof(string), typeof(Calendar), new PropertyMetadata(""));

        /// <summary>
        /// This value is shown in detail view header and represents the date formated, example: 6 January 2015
        /// </summary>
        public string DayTitle
        {
            get { return (string)GetValue(DayTitleProperty); }
            internal set { SetValue(DayTitleProperty, value); }
        }
        ...
        public static readonly DependencyProperty DayTitleProperty =
            DependencyProperty.Register("DayTitle", typeof(string), typeof(Calendar), new PropertyMetadata(""));
        ...
        /// </summary>
        public IDateToBrushConverter BackgroundColorConverter
        {
            get { return (IDateToBrushConverter)GetValue(BackgroundColorConverterProperty); }
            set { SetValue(BackgroundColorConverterProperty, value); }
        }
        ...
        /// </summary>
        public static readonly DependencyProperty BackgroundColorConverterProperty =
            DependencyProperty.Register("BackgroundColorConverter", typeof(IDateToBrushConverter), typeof(Calendar), new PropertyMetadata(null));
        ...
        public override void OnApplyTemplate()
        {
            ...
            previousButton = GetTemplateChild("PreviousMonthButton") as Button;
            if (previousButton != null) previousButton.Click += PreviousButtonClick;
            nextButton = GetTemplateChild("NextMonthButton") as Button;
